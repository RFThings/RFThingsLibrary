...
rft_status_t rfthings_lr11xx::init(rft_region_t region) {
	...
	rf_switch_setup.enable 	= LR11XX_SYSTEM_RFSW0_HIGH | LR11XX_SYSTEM_RFSW1_HIGH | LR11XX_SYSTEM_RFSW2_HIGH | LR11XX_SYSTEM_RFSW3_HIGH;
	rf_switch_setup.standby = 0;
	rf_switch_setup.rx 		= LR11XX_SYSTEM_RFSW0_HIGH | LR11XX_SYSTEM_RFSW3_HIGH;
	rf_switch_setup.tx 		= LR11XX_SYSTEM_RFSW0_HIGH | LR11XX_SYSTEM_RFSW1_HIGH | LR11XX_SYSTEM_RFSW3_HIGH;
	rf_switch_setup.tx_hp 	= LR11XX_SYSTEM_RFSW1_HIGH | LR11XX_SYSTEM_RFSW3_HIGH;
...
uint8_t rfthings_lr11xx::compute_lora_ldro(void)
{
    ...
    case RFT_LORA_BANDWIDTH_200KHZ:
    case RFT_LORA_BANDWIDTH_125KHZ:
        if( ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_12 ) || ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_11 ) )
        {
            return 1;
        }
        else
    ...
    case RFT_LORA_BANDWIDTH_62KHZ:
        if( ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_12 ) || ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_11 )||
			( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_10 ) )
        {
            return 1;
        }
        else
    ...
    case RFT_LORA_BANDWIDTH_41KHZ:
        if( ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_12 ) || ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_11 ) ||
			( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_10 ) || ( lora_params.spreading_factor == RFT_LORA_SPREADING_FACTOR_9 ) )
        {
            return 1;
        }
        else
